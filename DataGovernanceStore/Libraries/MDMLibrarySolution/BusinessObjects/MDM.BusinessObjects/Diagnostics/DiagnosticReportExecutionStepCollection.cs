...
namespace MDM.BusinessObjects.Diagnostics
{
    ...
    /// </summary>
    [DataContract]
    public class DiagnosticReportExecutionStepCollection : ICollection<DiagnosticReportExecutionStep>, IEnumerable<DiagnosticReportExecutionStep>
    {
        #region Fields
        ...
        [DataMember]
        private Collection<DiagnosticReportExecutionStep> _executionSteps = new Collection<DiagnosticReportExecutionStep>();
        ...
        /// </summary>
        public DiagnosticReportExecutionStepCollection() : base() { }

        /// <summary>
        /// Constructor which takes Xml as input
        /// </summary>
        public DiagnosticReportExecutionStepCollection(String valueAsXml)
        {
        ...
        public DiagnosticReportExecutionStepCollection(IList<DiagnosticReportExecutionStep> executionStepsList)
        {
            this._executionSteps = new Collection<DiagnosticReportExecutionStep>(executionStepsList);
        }
        ...
        {
            if (obj is DiagnosticReportExecutionStepCollection)
            {
                DiagnosticReportExecutionStepCollection objectToBeCompared = obj as DiagnosticReportExecutionStepCollection;
        ...
        {
            Int32 hashCode = 0;
            foreach (DiagnosticReportExecutionStep attr in this._executionSteps)
            {
                ...
                try
                {
                    ...
                    while (!reader.EOF)
                    {
                        if (reader.NodeType == XmlNodeType.Element && reader.Name == "ExecutionStep")
                        {
                            ...
                            {
                                DiagnosticReportExecutionStep executionStep = new DiagnosticReportExecutionStep(executionStepsXml);
        ...
        public void Add(DiagnosticReportExecutionStep item)
        {
        ...
        /// </returns>
        public bool Contains(DiagnosticReportExecutionStep item)
        {
        ...
        public void CopyTo(DiagnosticReportExecutionStep[] array, int arrayIndex)
        {
        ...
        public bool Remove(DiagnosticReportExecutionStep item)
        {
        ...
        public IEnumerator<DiagnosticReportExecutionStep> GetEnumerator()
        {
        ...
        public String ToXml()
        {
            ...
            foreach (DiagnosticReportExecutionStep executionStep in this._executionSteps)
            {
