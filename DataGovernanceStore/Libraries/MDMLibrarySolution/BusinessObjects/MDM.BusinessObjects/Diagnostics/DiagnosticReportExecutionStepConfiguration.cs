...
namespace MDM.BusinessObjects.Diagnostics
{
    ...
    /// </summary>
    [DataContract]
    public class DiagnosticReportExecutionStepConfiguration : ObjectBase
    {
        #region Fields
        ...
        /// </summary>
        public DiagnosticReportExecutionStepConfiguration()
            : base()
        {
        }
        ...
        public DiagnosticReportExecutionStepConfiguration(String valuesAsXml)
        {
