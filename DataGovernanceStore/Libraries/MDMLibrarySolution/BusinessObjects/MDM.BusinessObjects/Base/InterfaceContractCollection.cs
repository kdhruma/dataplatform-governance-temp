...
namespace MDM.BusinessObjects
{
        ...
        where TBusinessObject : TBusinessObjectInterface
    {
        ...
        /// </summary>
        /// <param name="items">The object to adds to the <see cref="T:System.Collections.Generic.ICollection`1" />.</param>
        public void AddRange(ICollection<TBusinessObject> items)
        {
            if (items != null && items.Count > 0)
            {
                foreach (TBusinessObject item in items)
                {
