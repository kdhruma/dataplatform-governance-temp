...
namespace MDM.BusinessObjects.Jobs
{
    ...
    /// <summary>
    /// Specifies the Job Parameter
    /// </summary>
    [DataContract]
    public sealed class JobParameter : ObjectBase, IJobParameter
    {
        #region Fields
        ...
        /// Initializes a new instance of the Parameter class.
        /// </summary>
        public JobParameter(String valuesAsXml)
        {
            LoadJobParameter(valuesAsXml);
        }
        ...
        ///     Sample XML:
        /// </example>
        public void LoadJobParameter(String valuesAsXml)
        {
            if (!String.IsNullOrWhiteSpace(valuesAsXml))
            {
                ...
                try
                {
                    ...
                    while (!reader.EOF)
                    {
                        ...
                        {
                            #region Read JobParameter Properties
        ...
        public String ToXml()
        {
            ...
            //JobParameter node start
            xmlWriter.WriteStartElement("JobParameter");
        ...
        public String ToXml(ObjectSerialization serialization)
        {
            ...
            else
            {
                ...
                if (serialization == ObjectSerialization.ProcessingOnly)
                {
                    ...
                    #region Write JobParameter Properties for ProcessingOnly JobParameter Xml
