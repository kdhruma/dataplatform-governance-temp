...
namespace MDM.BusinessObjects.Imports
{
    ...
    /// <summary>
    /// Specifies the Reader Setting
    /// </summary>
    [DataContract]
    public sealed class ReaderSetting : ObjectBase, IReaderSetting
    {
        #region Fields
        ...
        /// </summary>
        public ReaderSetting(String name, String value)
        {
            this.Name = name;
            this.Value = value;
        }
        ...
        /// Initializes a new instance of the Parameter class.
        /// </summary>
        public ReaderSetting(String valuesAsXml)
        {
            LoadReaderSetting(valuesAsXml);
        }
        ...
        ///<summary>
        /// Load ReaderSetting object from XML.
        /// </summary>
        /// <param name="valuesAsXml">XML having xml value</param>
        /// <example>
        ///     Sample XML:
        /// </example>
        public void LoadReaderSetting(String valuesAsXml)
        {
            if (!String.IsNullOrWhiteSpace(valuesAsXml))
            {
                ...
                try
                {
                    ...
                    while (!reader.EOF)
                    {
                        ...
                        {
                            #region Read ReaderSetting Properties
        ...
        public String ToXml()
        {
            ...
            //ReaderSetting node start
            xmlWriter.WriteStartElement("ReaderSetting");
        ...
        public String ToXml(ObjectSerialization serialization)
        {
            ...
            else
            {
                ...
                if (serialization == ObjectSerialization.ProcessingOnly)
                {
                    ...
                    #region Write ReaderSetting Properties for ProcessingOnly ReaderSetting Xml
