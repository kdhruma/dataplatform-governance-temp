...
namespace MDM.BusinessObjects.Imports
{
    ...
    public class ExecutionStep : MDMObject
    {
        ...
        /// Step configuration
        /// </summary>
        private StepConfiguration _stepConfiguration = new StepConfiguration();
        ...
        /// </summary>
        [DataMember]
        public StepConfiguration StepConfiguration
        {
            get
            {
                ...
                try
                {
                    ...
                    while (!reader.EOF)
                    {
                        ...
                        else if (reader.NodeType == XmlNodeType.Element && reader.Name == "StepConfiguration")
                        {
                            ...
                            {
                                StepConfiguration stepConfiguration = new StepConfiguration(StepConfigurationXml);
