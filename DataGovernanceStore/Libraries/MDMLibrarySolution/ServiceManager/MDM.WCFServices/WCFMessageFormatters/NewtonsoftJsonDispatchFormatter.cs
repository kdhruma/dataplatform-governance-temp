    ...
    class NewtonsoftJsonDispatchFormatter : IDispatchMessageFormatter
    {
        ...
        public void DeserializeRequest(Message message, object[] parameters)
        {
            ...
            if (parameters.Length == 1)
            {
                ...
                String messageAsString = sr.ReadToEnd();
                Object json = JsonConvert.DeserializeObject(messageAsString);
                parameters[0] = json.ToString();
            }
            else
            {
        ...
        public Message SerializeReply(MessageVersion messageVersion, object[] parameters, object result)
        {
            ...
            Message replyMessage = Message.CreateMessage(messageVersion, operation.Messages[1].Action, new JsonBodyWriter(result.ToString()));
