...
{
    /// <summary>
    /// Import Templates data access layer
    /// </summary>
    public class ImportTemplateDA : SqlClientDataAccessBase
    {
        #region Fields
        ...
        public Template GetImportTemplate(Int32 importTemplateId, String profileName, TemplateType templateType, CallerContext callerContext)
        {
            ...
            try
            {
                ...
                parameters[0].Value = importTemplateId;
                ...
                if (reader != null)
                {
                    while (reader.Read())
                    {
                        ...
                        {
                            TemplateType importTemplateType = TemplateType.UnKnown;
                            Enum.TryParse(reader["TemplateType"].ToString(), out importTemplateType);
                            template.TemplateType = importTemplateType;
                        }
