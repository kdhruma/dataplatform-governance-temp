...
namespace MDM.IntegrationManager.Data
{
    ...
    /// </summary>
    public class IntegrationInboundAggregationQueueDA : SqlClientDataAccessBase
    {
        #region Fields

        private const String _getMethodName = "MDM.IntegrationManager.Data.AggregationInboundQueueDA.Get";
        ...
        public AggregationInboundQueueItemCollection Get(String logStatus, Int64 fromCount, Int64 toCount, String programName, String userName, Int16 serverId, DBCommandProperties command)
        {
            ...
            AggregationInboundQueueItemCollection inboundQueueItems = new AggregationInboundQueueItemCollection();
        ...
        private AggregationInboundQueueItemCollection ReadInboundQueueItems(SqlDataReader reader)
        {
            AggregationInboundQueueItemCollection inboundQueueItemCollection = new AggregationInboundQueueItemCollection();
            ...
            if (reader != null)
            {
                while (reader.Read())
                {
                    ...
                    AggregationInboundQueueItem item = new AggregationInboundQueueItem();
                    item.Id = id;
