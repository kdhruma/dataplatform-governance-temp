...
namespace MDM.IntegrationManager.Business
{
    ...
    /// </summary>
    public class IntegrationInboundAggregationQueueBL : BusinessLogicBase
    {
        #region Fields
        ...
        private IntegrationInboundAggregationQueueDA _aggregationInboundQueueDA = new IntegrationInboundAggregationQueueDA();

        private const String _processMethodName = "MDM.IntegrationManager.Business.AggregationInboundQueueBL.Process";
        private const String _getMethodName = "MDM.IntegrationManager.Business.AggregationInboundQueueBL.Get";
        private const String _markAsProcessedMethodName = "MDM.IntegrationManager.Business.AggregationInboundQueueBL.MarkAsProcessed";
        ...
        /// </summary>
        public IntegrationInboundAggregationQueueBL()
        {
        ...
        /// <summary>
        /// Get aggregation inbound queue item for a given range of Ids
        /// </summary>
        ...
        public AggregationInboundQueueItemCollection Get(String logStatus, Int64 fromCount, Int64 toCount, CallerContext callerContext)
        {
            AggregationInboundQueueItemCollection inboundQueueItems = null;
            ...
            if (fromCount > -1 && toCount > -1 && !String.IsNullOrWhiteSpace(logStatus))
            {
                ...
                {
                    inboundQueueItems = _aggregationInboundQueueDA.Get(logStatus, fromCount, toCount, callerContext.ProgramName, userName, (Int16)callerContext.ServerId, command);
        ...
        private void ValidateCallerContext(CallerContext callerContext)
        {
            ...
            {
                throw new MDMOperationException("111846", "CallerContext cannot be null.", "AggregationInboundQueueBL.Process", String.Empty, "Process");
            }
        }
