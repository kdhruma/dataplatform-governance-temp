...
namespace MDM.Integration.Interfaces
{
    ...
    /// <summary>
    /// Connector base implementation. All connectors need to inherit from this class and override required methods based on implementation.
    /// </summary>
    public class ConnectorBase : IConnector
    {
        ...
        /// Result of operation
        /// </returns>
        public virtual bool Register(IConnectorProfile iConnectorProfile, ICallerContext iCallerContext)
        {
        ...
        /// <param name="iCallerContext">Context of caller making call to this API.</param>
        /// <returns>
        /// IntegrationMessages to be processed due to given integration activity
        /// </returns>
        public virtual IIntegrationMessageCollection GetOutboundMessages(IIntegrationActivity iIntegrationActivity, IConnectorProfile iConnectorProfile, ICallerContext iCallerContext)
        {
            throw new NotImplementedException();
        }
        ...
        /// IntegrationMessages to be processed due to given integration activity
        /// </returns>
        public virtual IIntegrationMessageCollection GetInboundMessages(IIntegrationActivity iIntegrationActivity, IConnectorProfile iConnectorProfile, ICallerContext iCallerContext)
        {
            throw new NotImplementedException();
        }
        ...
        /// <param name="iCallerContext">Context of caller making call to this API.</param>
        /// <returns>
        ///   <see cref="IMessageQualificationResult" />Indicates if message is qualified. If not, what is the next scheduled time it should be re-processed.
        /// </returns>
        public virtual IMessageQualificationResult IsQualified(IIntegrationMessage iIntegrationMessage, IConnectorProfile iConnectorProfile, ICallerContext iCallerContext)
        {
            throw new NotImplementedException();
        }
        ...
        /// <param name="iCallerContext">Context of caller making call to this API.</param>
        /// <returns>
        ///   <see cref="IIntegrationData" /> which will be sent to external system and is understood by that system
        /// </returns>
        public virtual IIntegrationData Transform(IIntegrationMessage iIntegrationMessage, IConnectorProfile iConnectorProfile, ICallerContext iCallerContext)
        {
            throw new NotImplementedException();
        }
        ...
        /// Result of operation
        /// </returns>
        public virtual IOperationResult Send(IIntegrationData iIntegrationData, IConnectorProfile iConnectorProfile, ICallerContext iCallerContext)
        {
            throw new NotImplementedException();
        }
        ...
        /// Result of operation
        /// </returns>
        public virtual IOperationResult Receive(IIntegrationMessage iIntegrationMessage, IConnectorProfile iConnectorProfile, ICallerContext iCallerContext)
        {
            throw new NotImplementedException();
        }
        ...
        /// Result of operation
        /// </returns>
        public virtual IOperationResult ProcessOutboundMessage(IIntegrationMessage iIntegrationMessage, IConnectorProfile iConnectorProfile, ICallerContext iCallerContext)
        {
            throw new NotImplementedException();
        }
        ...
        /// Result of operation
        /// </returns>
        public virtual IOperationResult ProcessInboundMessage(IIntegrationMessage iIntegrationMessage, IConnectorProfile iConnectorProfile, ICallerContext iCallerContext)
        {
            throw new NotImplementedException();
        }
        ...
        /// </returns>
        public virtual IIntegrationMessageCollection GetOutboundAggregatedMessages(IIntegrationMessageCollection messagesToBeAggregated, IConnectorProfile iConnectorProfile, ICallerContext iCallerContext)
        {
            throw new NotImplementedException();
        }
        ...
        /// Aggregated IntegrationMessages to be processed
        /// </returns>
        public virtual IIntegrationMessageCollection GetInboundAggregatedMessages(IIntegrationMessageCollection messagesToBeAggregated, IConnectorProfile iConnectorProfile, ICallerContext iCallerContext)
        {
            throw new NotImplementedException();
        }
    }
