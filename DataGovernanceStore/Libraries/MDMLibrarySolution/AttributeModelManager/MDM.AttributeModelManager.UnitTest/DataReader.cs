...
namespace MDM.AttributeModelManager.UnitTest
{
    public class DataReader
    {
        ...
        public static String ReadMethodData(String fileName, String methodName )
        {
            ...
            //Get file path
            DirectoryInfo projectDir = new DirectoryInfo(@"D:\RS 7.0\Development\Libraries\MDMLibrarySolution\AttributeModelManager\MDM.AttributeModelManager.UnitTest\Data");
