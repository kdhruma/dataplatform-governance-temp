...
namespace MDM.ImportSources.RSXliff
{
    ...
    /// <summary>
    /// This is the wrapper class for a RSXliff 1.0 specific profile. Any functionality specific to this version can be overridden here.
    /// </summary>
    public class XliffSource10 : BaseXliffSource, IEntityImportSourceData
    {
        private IJobResultHandler _jobResultHandler = null;

        /// <summary>
        /// Xliff10 source constructor having filePath as the parameter
        /// </summary>
        /// <param name="filePath"></param>
        public XliffSource10(string filePath): base(filePath)
        {
        }
