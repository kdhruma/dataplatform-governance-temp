...
namespace MDM.ImportSources.RSXml
{
    ...
    /// </summary>
    public class XmlSource45 : BaseXmlSource, IEntityImportSourceData
    {

        private IJobResultHandler _jobResultHandler = null;

        public XmlSource45(string filePath)
            : base(filePath)
        {
        ...
        Boolean IEntityImportSourceData.UpdateErrorEntities(BusinessObjects.EntityOperationResultCollection errorEntities, MDMCenterApplication application, MDMCenterModules module)
        {
            return true;
        }

        Boolean IEntityImportSourceData.UpdateErrorRelationships(BusinessObjects.RelationshipOperationResultCollection errorRelationships, MDMCenterApplication application, MDMCenterModules module)
        {
            return true;
        }

        Boolean IEntityImportSourceData.UpdateErrorAttributes(BusinessObjects.AttributeOperationResultCollection errorAttributes, MDMCenterApplication application, MDMCenterModules module)
        {
            return true;
        }

        Boolean IEntityImportSourceData.UpdateErrorAttributes(Core.AttributeModelType attributeType, string entityList, string errorMessage, MDMCenterApplication application, MDMCenterModules module)
        {
            return true;
        }

        Boolean IEntityImportSourceData.UpdateSuccessEntities(BusinessObjects.EntityCollection entities, MDMCenterApplication application, MDMCenterModules module)
        {
            return true;
        }

        Boolean IEntityImportSourceData.UpdateSuccessAttributes(Core.AttributeModelType attributeType, BusinessObjects.EntityCollection entities, MDMCenterApplication application, MDMCenterModules module)
        {
            return true;
        }
