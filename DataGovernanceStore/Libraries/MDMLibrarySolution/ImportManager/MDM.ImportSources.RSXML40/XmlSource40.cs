...
namespace MDM.ImportSources.RSXml
{
    ...
    /// <summary>
    /// This is the wrapper class for a 4.0 specific profile. Any functionality specific to this version can be overridden here.
    /// </summary>
    public class XmlSource40 : BaseXmlSource, IEntityImportSourceData
    {
        private IJobResultHandler _jobResultHandler = null;

        public XmlSource40(string filePath)
            : base(filePath)
        {
