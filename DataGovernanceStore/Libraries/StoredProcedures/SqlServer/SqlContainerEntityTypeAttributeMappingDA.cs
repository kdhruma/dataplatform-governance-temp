...
namespace Riversand.StoredProcedures
{
	...
	/// 
	/// </summary>
	public class SqlContainerEntityTypeAttributeMappingDA
	{
		/// <summary>
		/// Private constructor
		/// </summary>		
		private SqlContainerEntityTypeAttributeMappingDA()
		{
		}
		...
		public static DataTable Process(SqlXml DataXML, SqlString LoginUserID, SqlString ProgramName, IDbConnection connection, IDbTransaction transaction)
		{
			...
			try
			{
				...
				try
				{
					using(SqlDataAdapter dataAdapter = new SqlDataAdapter("usp_DataModelManager_ContainerEntityTypeAttribute_Process", (SqlConnection)connection))
					{
						...
						if (Constants.TRACING_ENABLED)
						{
							MDMTraceHelper.EmitTraceEvent(System.Diagnostics.TraceEventType.Verbose, "Calling:[usp_DataModelManager_ContainerEntityTypeAttribute_Process]");
						}
