...
namespace Riversand.StoredProcedures
{
	...
	/// 
	/// </summary>
	public class SqlContainerEntityTypeMappingDA
	{
		/// <summary>
		/// Private constructor
		/// </summary>		
		private SqlContainerEntityTypeMappingDA()
		{
		}
        ...
        /// 
        /// </summary>
		public static DataTable GetAll(SqlInt32 OrgId, SqlInt32 CatalogID, SqlInt32 NodeType, IDbConnection connection, IDbTransaction transaction)
		{
			...
			try
			{
				...
				try
				{
					using(SqlDataAdapter dataAdapter = new SqlDataAdapter("usp_DataModelManager_ContainerEntityType_GETAll", (SqlConnection)connection))
					{
						...
						if (Constants.TRACING_ENABLED)
						{
							MDMTraceHelper.EmitTraceEvent(System.Diagnostics.TraceEventType.Verbose, "Calling:[usp_DataModelManager_ContainerEntityType_GETAll]");
						}
        ...
        /// 
        /// </summary>
		public static DataTable GetByContainer(SqlInt32 CatalogID, IDbConnection connection, IDbTransaction transaction)
		{
			DateTime startDate = DateTime.Now;
			bool internalConnect = false;
			try
			{
				...
				try
				{
					using(SqlDataAdapter dataAdapter = new SqlDataAdapter("usp_DataModelManager_ContainerEntityType_GetByContainer", (SqlConnection)connection))
					{
						SqlCommand command = dataAdapter.SelectCommand;
						command.Transaction = (SqlTransaction)transaction;
						command.CommandType = CommandType.StoredProcedure;
						...
						if (Constants.TRACING_ENABLED)
						{
							MDMTraceHelper.EmitTraceEvent(System.Diagnostics.TraceEventType.Verbose, "Calling:[usp_DataModelManager_ContainerEntityType_GetByContainer]");
						}
		...
		public static DataTable GetByEntity(SqlInt32 NodeType, IDbConnection connection, IDbTransaction transaction)
		{
			...
			try
			{
				...
				try
				{
					using(SqlDataAdapter dataAdapter = new SqlDataAdapter("usp_DataModelManager_ContainerEntityType_GetByEntity", (SqlConnection)connection))
					{
						SqlCommand command = dataAdapter.SelectCommand;
						command.Transaction = (SqlTransaction)transaction;
						command.CommandType = CommandType.StoredProcedure;
						...
						if (Constants.TRACING_ENABLED)
						{
							MDMTraceHelper.EmitTraceEvent(System.Diagnostics.TraceEventType.Verbose, "Calling:[usp_DataModelManager_ContainerEntityType_GetByEntity]");
						}
        ...
        /// 
        /// </summary>
		public static DataTable GetByOrg(SqlInt32 OrgId, IDbConnection connection, IDbTransaction transaction)
		{
			DateTime startDate = DateTime.Now;
			bool internalConnect = false;
			try
			{
				...
				try
				{
					using(SqlDataAdapter dataAdapter = new SqlDataAdapter("usp_DataModelManager_ContainerEntityType_GetByOrg", (SqlConnection)connection))
					{
						SqlCommand command = dataAdapter.SelectCommand;
						command.Transaction = (SqlTransaction)transaction;
						command.CommandType = CommandType.StoredProcedure;
						...
						if (Constants.TRACING_ENABLED)
						{
							MDMTraceHelper.EmitTraceEvent(System.Diagnostics.TraceEventType.Verbose, "Calling:[usp_DataModelManager_ContainerEntityType_GetByOrg]");
						}
		...
		public static DataTable Process(SqlXml DataXML, SqlString LoginUserID, SqlString ProgramName, IDbConnection connection, IDbTransaction transaction)
		{
			...
			try
			{
				...
				try
				{
					using(SqlDataAdapter dataAdapter = new SqlDataAdapter("usp_DataModelManager_ContainerEntityType_Process", (SqlConnection)connection))
					{
						SqlCommand command = dataAdapter.SelectCommand;
						command.Transaction = (SqlTransaction)transaction;
						command.CommandType = CommandType.StoredProcedure;
						...
						if (Constants.TRACING_ENABLED)
						{
							MDMTraceHelper.EmitTraceEvent(System.Diagnostics.TraceEventType.Verbose, "Calling:[usp_DataModelManager_ContainerEntityType_Process]");
						}
