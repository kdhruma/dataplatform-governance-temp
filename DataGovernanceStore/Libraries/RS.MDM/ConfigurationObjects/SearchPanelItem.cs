...
{    
    ...
    /// <summary>
    /// Represents a search attribute
    /// </summary>
    [XmlRoot("SearchPanelItem")]
    [Serializable()]
    public class SearchPanelItem:Object
    {
        #region Fields

        /// <summary>
        /// Represents the type of Search Attribute
        /// </summary>
        private core.AttributeModelType _attributeModelType = core.AttributeModelType.AttributeMaster;

        /// <summary>
        /// Represents the parameter list for the Search Item
        /// </summary>
        ...
        /// Represents the parameter list for the Search Item
        /// </summary>
        private core.PanelItemType _panelItemType = core.PanelItemType.Input;
        ...
        [Category("Properties")]
        [Description("Represents the type of Search Attribute")]
        [TrackChanges()]
        public core.AttributeModelType AttributeModelType
        {
            get
            {
        ...
        /// Represents the type of Search Attribute
        /// </summary>
        [XmlAttribute("PanelItemType")]
        [Category("Properties")]
        [Description("Represents the type of Control")]
        [TrackChanges()]
        public core.PanelItemType PanelItemType
        {
            get
            {
                return this._panelItemType;
            }
            set
            {
                this._panelItemType = value;
            }
        }
        ...
        /// </summary>
        /// <returns>XML representation of Search Attribute Rule Xml</returns>
        public override String ToXml()
        {
            String searchPanelItemXml = String.Empty;

            StringWriter sw = new StringWriter();
            XmlTextWriter xmlWriter = new XmlTextWriter(sw);

            #region Search Attribute Rule Node

            //MenuItem node start
            xmlWriter.WriteStartElement("SearchPanelItem");
            ...
            xmlWriter.WriteAttributeString("PanelItemType", this.PanelItemType.ToString());
            ...
            #endregion AttributeModelType

            xmlWriter.Flush();

            //Get the actual XML
            searchPanelItemXml = sw.ToString();

            xmlWriter.Close();
            sw.Close();

            return searchPanelItemXml;
        }
        ...
        public override void Validate(ref ValidationErrorCollection validationErrors)
        {
            ...
            {
                validationErrors.Add("The SearchItem does not contain any Parameter.", ValidationErrorType.Information, "Search Item", this);
            }
        }
